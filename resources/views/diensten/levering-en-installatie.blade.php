...
@section('content')
    ...
    <section class="bg-white py-16 lg:py-32 relative overflow-hidden" id="li-section1" data-header-light>
    ...
    <section class="bg-white py-16 lg:py-32 relative overflow-hidden" id="li-section2" data-header-light>
