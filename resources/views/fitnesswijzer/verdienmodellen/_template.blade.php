...
@section('content')
    ...
    <section class="bg-white py-16 lg:py-32 relative overflow-hidden" id="vd-section1">
    ...
    <section class="bg-white py-16 lg:py-32 relative overflow-hidden" id="vd-section3">
