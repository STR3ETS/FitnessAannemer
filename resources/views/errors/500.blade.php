...
<head>
    ...
    <title>Serverfout | Fitness Aannemer</title>
...
<body class="bg-secondary min-h-screen flex flex-col">
    <div class="flex-1 flex items-center justify-center px-4">
        <div class="text-center max-w-lg">
            ...
            <p class="text-primary text-8xl sm:text-9xl font-bold mb-4" style="font-family: 'Inter'">500</p>
            <h1 class="text-white text-2xl sm:text-3xl font-bold mb-4">Er ging iets mis</h1>
            <p class="text-white/50 text-sm leading-relaxed mb-10">Onze server heeft een probleem. Probeer het later opnieuw of neem contact met ons op als het probleem aanhoudt.</p>
