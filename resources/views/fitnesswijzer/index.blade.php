...
@section('content')
    <section class="bg-secondary pt-32 lg:pt-40 pb-16 lg:pb-30 relative overflow-hidden" id="fw-hero">
    ...
    <section class="bg-white py-16 lg:py-32 relative overflow-hidden" id="fw-section1" data-header-light>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 relative">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
                ...
                <div class="ip-block-media rounded-3xl aspect-[4/3] overflow-hidden">
                    <video data-src="{{ asset('shorts/fitnessaannemer-short-1.mp4') }}" class="lazy-video w-full h-full object-cover" autoplay muted loop playsinline preload="none"></video>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-white py-16 lg:py-32 relative overflow-hidden" id="fw-section3" data-header-light>
