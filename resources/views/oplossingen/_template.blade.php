...
@section('content')
    ...
    <section class="bg-white py-16 lg:py-32 relative overflow-hidden" id="opl-section1" data-header-light>
    ...
    <section class="bg-secondary py-16 lg:py-32 overflow-hidden" id="opl-section2">
    ...
    <section class="bg-white py-16 lg:py-32 relative overflow-hidden" id="opl-section3" data-header-light>
