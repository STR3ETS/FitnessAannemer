...
@section('content')
    <section class="bg-secondary pt-32 lg:pt-40 pb-16 lg:pb-30">
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            <div class="ip-hero-el flex items-center gap-2 mb-6">
                ...
                <a href="{{ url('/fitnesswijzer/gymreviews') }}" class="text-white/40 text-xs font-medium hover:text-white transition" style="font-family: 'Inter Tight'">Gymreviews</a>
                <i class="fa-solid fa-chevron-right text-white/20 text-[8px]"></i>
    ...
    <section class="bg-white py-16 lg:py-32 relative overflow-hidden" id="gd-section1">
    ...
    <section class="bg-white py-16 lg:py-32 relative overflow-hidden" id="gd-section3">
