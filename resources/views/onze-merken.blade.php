...
@section('content')
    ...
    <section class="bg-white py-16 lg:py-32 relative overflow-hidden" id="om-section1" data-header-light>
    ...
    <section class="bg-white py-16 lg:py-32 relative overflow-hidden" id="om-section3" data-header-light>
