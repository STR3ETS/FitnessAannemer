...
@section('content')
    <section class="bg-secondary pt-32 lg:pt-40 pb-16 lg:pb-30 relative overflow-hidden" id="or-hero">
        <div class="hidden lg:block absolute inset-y-0 right-0 w-1/2">
            <img src="{{ asset('assets/foto-assets/BluePrint-2024-photos-39-1024x683.jpg') }}" alt="" class="w-full h-full object-cover">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 relative">
            <div class="ip-hero-el flex items-center gap-2 mb-6">
                ...
                <span class="text-white/70 text-xs font-medium" style="font-family: 'Inter'">Onderhoud & reparaties</span>
            </div>
            <div class="max-w-3xl">
    ...
    <section class="bg-white py-16 lg:py-32 relative overflow-hidden" id="or-section1" data-header-light>
    ...
    <section class="bg-white py-16 lg:py-32 relative overflow-hidden" id="or-section2" data-header-light>
