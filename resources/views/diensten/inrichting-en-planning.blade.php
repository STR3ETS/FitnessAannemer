...
@section('content')
    ...
    <section class="bg-white py-16 lg:py-32 relative overflow-hidden" id="ip-zonering" data-header-light>
    ...
    <section class="bg-white py-16 lg:py-32 relative overflow-hidden" id="ip-apparatuur" data-header-light>
