...
@section('content')
    ...
    {{-- BLOK 3: WIE WIJ ZIJN --}}
    <section class="bg-white py-16 lg:py-32 relative overflow-hidden" id="oo-section1" data-header-light>
    ...
    {{-- BLOK 5: ONZE AANPAK --}}
    <section class="bg-white py-16 lg:py-32 relative overflow-hidden" id="oo-section3" data-header-light>
