...
<head>
    ...
    <title>Pagina niet gevonden | Fitness Aannemer</title>
...
<body class="bg-secondary min-h-screen flex flex-col">
    <div class="flex-1 flex items-center justify-center px-4">
        <div class="text-center max-w-lg">
            ...
            <p class="text-primary text-8xl sm:text-9xl font-bold mb-4" style="font-family: 'Inter'">404</p>
            <h1 class="text-white text-2xl sm:text-3xl font-bold mb-4">Pagina niet gevonden</h1>
            <p class="text-white/50 text-sm leading-relaxed mb-10">De pagina die je zoekt bestaat niet of is verplaatst. Geen zorgen, hieronder vind je de weg terug.</p>
            <div class="flex flex-col sm:flex-row items-center justify-center gap-3">
                ...
                <a href="{{ url('/projecten') }}" class="bg-white/10 border border-white/20 rounded-full px-6 py-3.5 text-white text-xs font-semibold hover:bg-white/20 transition">
                    Bekijk projecten
                </a>
            </div>
        </div>
